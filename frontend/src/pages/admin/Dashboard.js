  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8 text-center">
        <h2 className="text-4xl font-extrabold text-primary-dark mb-4 drop-shadow">Welcome, Admin!</h2>
      </div>
      ...
      <div className="flex flex-row justify-center items-center gap-8 mt-8 flex-wrap">
        <DashboardCard icon={<svg className="w-10 h-10 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5zm0 0v6m0 0H7m5 0h5"/></svg>} label="Students" value={stats && typeof stats.students !== 'undefined' ? stats.students : 0} color="from-blue-500 to-blue-700" />
        <DashboardCard icon={<svg className="w-10 h-10 text-pink-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>} label="Assignments/Quizzes" value={stats && typeof stats.quizzes !== 'undefined' ? stats.quizzes : 0} color="from-pink-500 to-pink-700" />
